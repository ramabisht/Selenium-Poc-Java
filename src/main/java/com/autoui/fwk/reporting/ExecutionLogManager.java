...
import com.autoui.fwk.annotations.Repeat;
import com.autoui.fwk.annotations.Step;
import com.autoui.fwk.core.BaseTest;
import com.autoui.fwk.execution.ExceptionManager;
...
/*
    ...
    public static void logTestSkip(ITestResult testResult) {
        ...
        _logger.error(String.format("Execution skipped for %s method %s", methodType.name(), testngMethod.getMethodName()), e);
     ...
     * is called from the {@link AutoUIListener}
     *
    ...
    public static void logListenerFailure(ITestResult testResult) {
        ITestNGMethod testngMethod = testResult.getMethod();
        Throwable e = testResult.getThrowable();
        _logger.error(String.format("Execution completed with errors for TEST method %s", testngMethod.getMethodName()), e);
    }
