...
public class RecoveryManager {
     ...
     * save it in a list
     *
     * @param recoveryClasses Comma separated fully qualified class names of Recovery Classes
     */
                ...
                try {
                    ...
                    if (WebRecovery.class.isAssignableFrom(clazz)) {
                        ...
                        _logger.warn(String.format(
                                "Provided Recovery client class %s is not  sub class of com.autoui.fwk.recovery.WebRecovery",
                                recoveryClass));
                    }
