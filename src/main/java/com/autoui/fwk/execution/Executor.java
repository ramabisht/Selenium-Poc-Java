...
import com.autoui.fwk.listeners.AutoUIListener;
...
class Executor {
    ...
    /**
     * Get tests from System property <b>autoui.tests</b>
     */
    private void getTests() {
        String testClassProperty = System.getProperty("autoui.tests");
        ...
        if (testDefinitions.isEmpty())
            throw new SetupFailedFatalException("No valid test cases specified to run via property autoui.tests");
    }

    /**
     * Get listeners from System property <b>autoui.listeners</b>
     *
     * @return List of Listener classes
     */
    @SuppressWarnings("unchecked")
    private ArrayList<Class<? extends ITestNGListener>> getListenerClasses() {
        String listenerStrings[] = System.getProperty("autoui.listeners", AutoUIListener.class.getName())
                .split(",");
        ...
        listeners.add(AutoUIListener.class);
    ...
    private String getOutputDirectory() {
        String outputDirectory = System.getProperty("autoui.reportdir", null);
        if (outputDirectory == null) {
            outputDirectory = "." + File.separator + "report";
            System.setProperty("autoui.reportdir", outputDirectory);
        }
    ...
    public void generateXmlSuite() {
        ...
        suite.setName(String.format("autoui-XML-Suite"));
    ...
    public void generateTestNGFileSuites() {
        String testSuitesProperty = System.getProperty("autoui.testsuites", null);
        if (testSuitesProperty == null)
            throw new SetupFailedFatalException(
                    "Property autoui.testsuites is not set. There is no TestNG xml file to run");
