 ...
 * com.autoui.tests.LoginTest and parameters user name and password. To run
 * tests via command line following command can be used
 *
 * <pre>
 * java -Dautoui.tests=LoginTest -DLoginTest.testclass=com.autoui.tests.LoginTest
 * 			-DLoginTest.userName=admin -DLoginTest.password=password
 * 				-cp test.jar com.autoui.fwk.execution.TestExecutor
 * </pre>
 *
 * @author rama.bisht
 */
