package com.autoui.fwk.selenium;
 ...
 * @author rama.bisht
 */
public class AutoUIWebDriverWait extends WebDriverWait {

    private final WebDriver driver;

    public AutoUIWebDriverWait(WebDriver driver, long timeOutInSeconds) {
